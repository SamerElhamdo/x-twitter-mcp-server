#!/usr/bin/env python3
"""
تشغيل بسيط لـ mcp-proxy مع Simple MCP Server
"""
...
def main():
    ...
    print("🚀 تشغيل mcp-proxy مع Simple MCP Server")
    print("=" * 50)
    print("📊 خادم بسيط ومتوافق")
    print("🔧 بدون مشاكل async/await")
    print("⚡ استجابة سريعة")
    print("=" * 50)
    print()
...
if __name__ == "__main__":
    ...
    if not Path("simple_mcp_server.py").exists():
        print("❌ ملف simple_mcp_server.py غير موجود")
        sys.exit(1)
